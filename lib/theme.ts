...
export const palettes: Record<PaletteName, CatppuccinPalette> = {
  latte: {
  ...
  frappe: {
    ...
    text: "#d5dffc", subtext1: "#c5cfee", subtext0: "#b5bddc",
  ...
  macchiato: {
    ...
    text: "#d9e2fc", subtext1: "#c8d0ec", subtext0: "#b5bdd9",
  ...
  mocha: {
    ...
    text: "#dce4fc", subtext1: "#cad2ea", subtext0: "#b6bdd6",
